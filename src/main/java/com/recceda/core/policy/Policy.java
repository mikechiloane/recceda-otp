 ...
 *
 * <p>Implement this interface to create custom rules for OTP generation, such as preventing duplicate
 * OTPs or limiting failed attempts.
 */
@FunctionalInterface
public interface Policy {
  /**
   * Checks if the policy is met for the given key and reason.
   *
